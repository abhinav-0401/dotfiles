...
require('lazy').setup({
  ...
  { -- Fuzzy Finder (files, lsp, etc)
    ...
    config = function()
      ...
      vim.keymap.set('n', '<leader>ss', builtin.builtin, { desc = '[S]earch [S]elect selescope' })
...
-- -- Automatically open netrw sidebar on startup
-- vim.api.nvim_create_autocmd('VimEnter', {
--   callback = function()
--     -- Check if the current buffer is empty before opening netrw
